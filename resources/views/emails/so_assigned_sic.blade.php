                ...
                <table class="container" role="presentation" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td class="p-24" style="padding:24px 24px 8px 24px;">
                            ...
                            <p style="font:400 14px/1.6 system-ui;color:#111;margin:0 0 12px 0;">
                                Anda ditunjuk sebagai SIC untuk menindaklanjuti SO berikut:
                            </p>

                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                style="border-collapse:separate;border-spacing:0 8px;">
                                <tr>
                                    <td style="width:160px;color:{{ $muted }};font:600 13px/1.4 system-ui;">
                                        Pelapor</td>
                                    <td style="font:500 14px/1.5 system-ui;color:#111;">{{ $so->nama }}
                                        ({{ $so->email }})</td>
                                </tr>
                                <tr>
                                    <td style="color:{{ $muted }};font:600 13px/1.4 system-ui;">Judul</td>
                                ...
                                <tr>
                                    ...
                                    <td style="font:500 14px/1.5 system-ui;color:#111;">{{ $so->lokasi_observasi }}
                                    </td>
                                </tr>
                                <tr>
