@php
    $brandColor = '#33A1E0'; // ganti dengan warna brand
    $muted = '#6c757d';
@endphp
<!doctype html>
<html lang="id">
...
<head>
    ...
    <title>{{ $subjectText ?? 'Notifikasi SO' }}</title>
    <style>
        /* fallback minimal untuk klien yang baca <style> */
                        ...
                        <td class="p-24" style="padding:24px 24px 8px 24px;">
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%"
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font:700 12px/1.2 system-ui;color:#155724;background:#d4edda;display:inline-block;padding:6px 10px;border-radius:999px;text-transform:uppercase;">
                                        {{ strtoupper($so->status ?? 'OPEN') }}
                                    </td>
                                </tr>
                            </table>
