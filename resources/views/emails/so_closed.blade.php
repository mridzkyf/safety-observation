@php
    $brandColor = '#78C841'; // ganti dengan warna brand MFI
    $muted = '#6c757d';
    $statusTxt = 'CLOSED';
@endphp
<!doctype html>
                    ...
                    <tr>
                        <td class="p-24" style="padding:24px 24px 8px 24px;">
                            ...
                            <p style="margin:16px 0 0 0;font:400 14px/1.6 system-ui;color:#111;">
                                Laporan Anda telah ditutup oleh pihak manager seksi anda. Jika membutuhkan tindak
                                lanjut, silakan
                                hubungi atasan atau admin SHE Division.
                                Terima kasih sudah melakukan pelaporan Safety Observation.
                            </p>
