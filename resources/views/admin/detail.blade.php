...
<body>
    ...
    <div class="content-wrapper"> <a href="{{ route('admin.tabel') }}" class="back-button">
        ...
        <div class="detail-card">
            ...
            @if (auth()->user()->role === 'admin' ||
                ...
                @if ($item->status === 'waiting' && !$item->sic_id)
                    <form method="POST" action="{{ route('approver.approve', $item->id) }}">
                        @csrf
                    ...
                    {{-- Tombol CLOSE --}}
                    <form method="POST" action="{{ route('approver.close', $item->id) }}" class="mt-2">
                        @csrf
