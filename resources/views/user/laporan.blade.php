        ...
        <div class = "table-container">
            ...
            <form method="GET" action="{{ route('user.laporan') }}" style="margin-bottom: 20px;">
                <div style="display: flex; flex-wrap: wrap; gap: 10px; align-items: center;">
                    <input type="text" id="tanggal_pelaporan" name="tanggal_pelaporan" placeholder="Tanggal"
                        class="form-control" value="{{ request('tanggal_pelaporan') }}"
                        style="min-width: 140px; height: 36px; font-size: 14px; border-radius: 6px; padding: 4px 10px; border: 1px solid #ccc;">

                    <input type="text" name="judul_temuan" placeholder="Judul Temuan" class="form-control"
                        value="{{ request('judul_temuan') }}"
                        style="min-width: 160px; height: 36px; font-size: 14px; border-radius: 6px; padding: 4px 10px; border: 1px solid #ccc;">

                    <select name="kategori" class="form-select"
                        style="min-width: 160px; height: 36px; font-size: 14px; border-radius: 6px; padding: 4px 10px; border: 1px solid #ccc;">
                        <option value="">Kategori</option>
                        <option value="Unsafe Condition"
                            {{ request('kategori') == 'Unsafe Condition' ? 'selected' : '' }}>Unsafe Condition
                        </option>
                        <option value="Unsafe Act" {{ request('kategori') == 'Unsafe Act' ? 'selected' : '' }}>
                            Unsafe Act</option>
                    </select>
            ...
            <div class="table-responsive">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                    ...
                    <div class="pagination">
                        {{ $ongoing->onEachSide(1)->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
        </div>
        <div class="table-container">
            ...
            <div class="table-responsive">
                ...
                <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                    ...
                    <div class="pagination">
                        {{ $closed->onEachSide(1)->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
        </div>
